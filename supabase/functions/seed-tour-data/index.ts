...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Build proper market_splits keyed by platform id, each with markets list
      ...
      meta: [
        {
          ...
          phases: [
            { id: "q1-m-us-tof", name: "TOF - Demand Capture", funnelStage: "TOF",
              objective: "OUTCOME_SALES", optimizationGoal: "OFFSITE_CONVERSIONS",
              budgetPercentage: 50, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: "2026-02-22",
              adSets: [{ id: "q1-as-1", name: "Broad + LAL", budgetPercentage: 100, dimensionValue: "broad" }] },
            { id: "q1-m-us-mof", name: "MOF - Intent Amplification", funnelStage: "MOF",
              objective: "OUTCOME_SALES", optimizationGoal: "OFFSITE_CONVERSIONS",
              budgetPercentage: 30, budgetType: "daily",
              startDate: "2026-02-22", endDate: "2026-03-16",
              adSets: [{ id: "q1-as-2", name: "Engagers + Visitors", budgetPercentage: 100, dimensionValue: "retarget" }] },
            { id: "q1-m-us-bof", name: "BOF - Conversion Recovery", funnelStage: "BOF",
              objective: "OUTCOME_SALES", optimizationGoal: "OFFSITE_CONVERSIONS",
              budgetPercentage: 20, budgetType: "daily",
              startDate: "2026-03-16", endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-3", name: "ATC + IC", budgetPercentage: 100, dimensionValue: "retarget" }] },
          ],
        },
        {
          ...
          strategy: "full_funnel", strategyFocus: "conversions",
          phases: [
            { id: "q1-m-uk-tof", name: "TOF", funnelStage: "TOF",
              objective: "OUTCOME_AWARENESS", optimizationGoal: "REACH",
              budgetPercentage: 60, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: "2026-02-28",
              adSets: [{ id: "q1-as-uk-1", name: "Broad UK", budgetPercentage: 100, dimensionValue: "broad" }] },
            { id: "q1-m-uk-bof", name: "BOF", funnelStage: "BOF",
              objective: "OUTCOME_SALES", optimizationGoal: "OFFSITE_CONVERSIONS",
              budgetPercentage: 40, budgetType: "daily",
              startDate: "2026-02-28", endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-uk-2", name: "Retargeting UK", budgetPercentage: 100, dimensionValue: "retarget" }] },
          ],
        },
      ],
      tiktok: [
        {
          ...
          strategy: "full_funnel", strategyFocus: "traffic",
          phases: [
            { id: "q1-tt-us-aw", name: "Awareness", funnelStage: "awareness",
              objective: "REACH", optimizationGoal: "REACH",
              budgetPercentage: 50, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: "2026-02-22",
              adSets: [{ id: "q1-as-tt-1", name: "Gen Z & Millennials", budgetPercentage: 100, dimensionValue: "broad" }] },
            { id: "q1-tt-us-conv", name: "Conversion", funnelStage: "conversion",
              objective: "CONVERSIONS", optimizationGoal: "CONVERT",
              budgetPercentage: 50, budgetType: "daily",
              startDate: "2026-02-22", endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-tt-2", name: "Retargeting", budgetPercentage: 100, dimensionValue: "retarget" }] },
          ],
        },
        {
          ...
          strategy: "awareness", strategyFocus: "awareness",
          phases: [
            { id: "q1-tt-de-aw", name: "Awareness", funnelStage: "awareness",
              objective: "REACH", optimizationGoal: "REACH",
              budgetPercentage: 100, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-tt-de-1", name: "Broad DE", budgetPercentage: 100, dimensionValue: "broad" }] },
          ],
        },
      ],
      google: [
        {
          ...
          phases: [
            { id: "q1-g-us-brand", name: "Search - Brand", funnelStage: "conversion",
              objective: "SALES", optimizationGoal: "CONVERSIONS",
              budgetPercentage: 50, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-g-1", name: "Brand Keywords", budgetPercentage: 100, dimensionValue: "brand" }] },
            { id: "q1-g-us-pmax", name: "Performance Max", funnelStage: "conversion",
              objective: "SALES", optimizationGoal: "CONVERSIONS",
              budgetPercentage: 50, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-g-2", name: "PMax Asset Group", budgetPercentage: 100, dimensionValue: "pmax" }] },
          ],
        },
        {
          ...
          phases: [
            { id: "q1-g-uk-brand", name: "Search - Brand", funnelStage: "conversion",
              objective: "SALES", optimizationGoal: "CONVERSIONS",
              budgetPercentage: 100, budgetType: "daily",
              startDate: formatDate(q1Start), endDate: formatDate(q1End),
              adSets: [{ id: "q1-as-g-uk-1", name: "Brand UK", budgetPercentage: 100, dimensionValue: "brand" }] },
          ],
        },
      ],
    };
