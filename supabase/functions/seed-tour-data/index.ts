...
Deno.serve(async (req) => {
  ...
  try {
          ...
          },
          {
            ...
            phases: [
              ...
              },
              {
                ...
                metaOptimizationLocation: "WEBSITE",
                metaConversionCount: "all_conversions",
                metaClickWindow: 7, metaViewWindow: 1,
                metaAdvantagePlusCampaign: false,
                metaAdvantagePlusAudience: false, metaAdvantagePlusCreative: true,
            ...
            phases: [
              {
                ...
                tiktokBidStrategy: "BID_TYPE_NO_BID", tiktokBillingEvent: "CPM",
                tiktokOptimizationLocation: "WEBSITE",
                tiktokAttributionWindow: "SEVEN_DAYS",
              ...
              },
              {
                ...
                startDate: formatDate(startDate), endDate: formatDate(endDate),
                tiktokSmartPlusEnabled: false, tiktokPlacementType: "PLACEMENT_TYPE_AUTOMATIC",
                tiktokBidStrategy: "BID_TYPE_NO_BID", tiktokBillingEvent: "CPC",
                tiktokOptimizationLocation: "WEBSITE",
          ...
          },
          {
            ...
            phases: [
              ...
              },
              {
                ...
                tiktokBidStrategy: "BID_TYPE_NO_BID", tiktokBillingEvent: "CPC",
                tiktokOptimizationLocation: "WEBSITE",
                tiktokLandingPageUrl: "https://demo-brand.example.com/de",
            ...
            phases: [
              {
                ...
                googleCampaignType: "Search", googleObjective: "SALES",
                googleBidStrategy: "TARGET_CPA", googleTargetCpa: 12,
                budgetPercentage: 35, budgetType: "daily",
                startDate: formatDate(startDate), endDate: formatDate(endDate),
                googleSearchPartner: true,
                googleNetworkSettings: { searchNetwork: true, contentNetwork: false, partnerSearchNetwork: true },
                googleConversionGoal: "PURCHASE",
                googleLandingPageUrl: "https://demo-brand.example.com",
                adSets: [
              ...
              },
              {
                ...
                googleNetworkSettings: { searchNetwork: true, contentNetwork: false, partnerSearchNetwork: true },
                googleConversionGoal: "PURCHASE",
                googleLandingPageUrl: "https://demo-brand.example.com/shop",
                adSets: [
              ...
              },
              {
                ...
                googleCampaignType: "Performance Max", googleObjective: "SALES",
                googleBidStrategy: "TARGET_ROAS", googleTargetRoas: 400,
                budgetPercentage: 35, budgetType: "daily",
                startDate: formatDate(startDate), endDate: formatDate(endDate),
                googleOptimizedTargeting: true,
                googleFinalUrlExpansion: true,
            ...
            phases: [
              {
                ...
                googleCampaignType: "Search", googleObjective: "LEADS",
                googleBidStrategy: "MAXIMIZE_CLICKS",
                budgetPercentage: 60, budgetType: "daily",
                startDate: formatDate(startDate), endDate: formatDate(endDate),
                googleSearchPartner: true,
                googleNetworkSettings: { searchNetwork: true, contentNetwork: false, partnerSearchNetwork: true },
                googleConversionGoal: "SUBMIT_LEAD_FORM",
                googleLandingPageUrl: "https://demo-brand.example.com/uk",
              ...
              },
              {
                ...
                googleCampaignType: "Display", googleObjective: "LEADS",
                googleBidStrategy: "TARGET_CPA", googleTargetCpa: 8,
                budgetPercentage: 40, budgetType: "daily",
                startDate: formatDate(startDate), endDate: formatDate(endDate),
                googleOptimizedTargeting: true,
                googleNetworkSettings: { searchNetwork: false, contentNetwork: true, partnerSearchNetwork: false },
                googleConversionGoal: "SUBMIT_LEAD_FORM",
                googleLandingPageUrl: "https://demo-brand.example.com/uk",
    ...
    // ===== 7c. (Removed) Q1 2026 Cross-Platform Campaign — single demo ActiPlan only =====
