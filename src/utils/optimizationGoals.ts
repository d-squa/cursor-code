...
export const OPTIMIZATION_GOAL_METRICS: OptimizationGoalMetrics[] = [
  ...
  // OUTCOME_ENGAGEMENT — only goals with valid non-WEBSITE destination_types
  { objective: "OUTCOME_ENGAGEMENT", destination: "Facebook Page", goalNameOnInterface: "Maximize Number Of Follows or likes", goal: "PAGE_LIKES", kpi: "CPFL", costPerResultFormula: "amountSpent/PAGE_LIKES", rateName: "FLTR", resultRateFormula: "PAGE_LIKES/impressions" },
