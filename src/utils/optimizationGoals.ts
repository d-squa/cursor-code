...
export const OPTIMIZATION_GOAL_METRICS: OptimizationGoalMetrics[] = [
  ...
  { objective: "OUTCOME_ENGAGEMENT", destination: "Website", goalNameOnInterface: "Maximize Number Of Landing Page Views", goal: "LANDING_PAGE_VIEWS", kpi: "CPLV", costPerResultFormula: "amountSpent/LANDING_PAGE_VIEWS", rateName: "LPVTR", resultRateFormula: "LANDING_PAGE_VIEWS/impressions" },
  { objective: "OUTCOME_ENGAGEMENT", destination: "Website", goalNameOnInterface: "Maximize Number Of Link Clicks", goal: "LINK_CLICKS", kpi: "CPLC-W", costPerResultFormula: "amountSpent/LINK_CLICKS", rateName: "LCTR", resultRateFormula: "LINK_CLICKS/impressions" },
  { objective: "OUTCOME_ENGAGEMENT", destination: "Website", goalNameOnInterface: "Maximize Impressions", goal: "IMPRESSIONS", kpi: "CPM", costPerResultFormula: "amountSpent/impressions*1000", rateName: "PETR", resultRateFormula: "POST_ENGAGEMENT/impressions" },
  { objective: "OUTCOME_ENGAGEMENT", destination: "Website", goalNameOnInterface: "Maximize Daily Unique Reach", goal: "REACH", kpi: "CPR", costPerResultFormula: "amountSpent/REACH", rateName: "RR", resultRateFormula: "REACH/impressions" },
