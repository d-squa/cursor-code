...
const ACTION_TYPES = [
  ...
  { value: "pause_resume", label: "Pause/Resume", description: "Campaign or ad set pause/resume actions" },
  { value: "note", label: "Note", description: "General observations or documentation" },
];
