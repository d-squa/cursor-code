        ...
        <div className="space-y-4 py-4">
          ...
          {limitType === 'account_limit' && (
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium">{currentCount} / {AD_ACCOUNT_LIMITS[currentTier]}</span>
            </div>
          )}
          ...
          {limitType === 'swap_limit' && (
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium">{swapsUsed} / {SWAP_LIMITS[currentTier]}</span>
            </div>
          )}

          <div className="border-t pt-4">
            <p className="text-sm font-medium mb-3">
              Upgrade to {TIER_DISPLAY_NAMES[targetTier]} to unlock:
            </p>
