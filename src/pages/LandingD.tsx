...
const Landing = () => {
  ...
  return (
    <>
      <SEO
        title="Media Planning Tool | AI Campaign Forecasting Tool | ActiPlan"
        description="ActiPlan is an AI-powered media planning Tool that helps teams forecast campaign results, allocate budgets, and deploy paid media plans across platforms efficiently."
        keywords="media planning Tool, campaign forecasting tool, paid media planning platform, budget allocation software, AI media planning"
        ...
        canonical="https://actiplan.app/media-planning-software"
      />
        ...
        <section className="container mx-auto px-4 md:py-32 py-[60px]">
          <div className="max-w-4xl mx-auto text-center">
            <Badge variant="secondary" className="mb-4 md:mb-6 text-xs md:text-sm shadow-md border-transparent bg-gradient-to-r from-primary to-purple-600 text-primary-foreground hover:from-primary hover:to-purple-600">
              ...
              <span className="hidden sm:inline">AI-Powered Media Planning Tool</span>
              <span className="sm:hidden">AI-Powered Media Planning Tool</span>
            </Badge>
