...
const Landing = () => {
  ...
  return (
    <>
      <SEO
        title="AI Campaign Builder | Cross-Platform Paid Ads | ActiPlan"
        ...
        keywords="AI media buying software, ai campaign builder, AI campaign optimization tool, cross-platform automation, intelligent media buying"
        ogTitle="AI Campaign Builder | Cross-Platform Paid Ads | ActiPlan"
        ogDescription="Use AI Campaign Builder to automate campaign planning, activation, and optimization across all major ad platforms."
