  ...
  return (
    <>
      <SEO
        ...
        ogImage="https://cursor-code-gamma.vercel.app/logo.png"
        canonical="https://cursor-code-gamma.vercel.app/" />
        ...
        <section className="container mx-auto px-4 md:py-32 py-[60px]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-2xl mx-auto px-2">
              ActiPlan is Built for professional media planners & buyers managing omnichannel activations on Meta,
