...
const pricingTiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "2 user connections per platform",
      "12 ad account per platform",
  ...
  },
  {
    ...
    features: [
      ...
      "2 integrated media platforms (Meta & Tiktok)",
      "8 user connections per platform",
      "40 ad account per platform",
      "2 platforms per ActiPlan at a time",
      "2 ad account swaps per platform every month",
  ...
  },
  {
    ...
    features: [
      ...
      "2 integrated media platforms (Meta & Tiktok)",
      "20 user connection per platform",
    ...
    limitations: [],
    operationalLimits: "1 Owner, 1 Admin & 8 Team Members",
    cta: "Get Started",
    popular: false,
  },
];
